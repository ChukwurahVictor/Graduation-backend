<template>
    <div class="college-wrapper">
        ...
        <el-table :data="collegeList"
                  border
                  style="width: 100%">
            <el-table-column prop="college_title" label="分类" width="400" align="center"></el-table-column>
...
<script type="text/ecmascript-6">
  export default {
    ...
    methods: {
      ...
      addClick() {
        // 新增  跳转到新增页面
        this.$router.push({name: 'createCollegeInfo'})
      },
      editClick(index, row) {
        // 编辑 跳转到新增页面
        console.log('row', row);
        this.$router.push({name: 'createCollegeInfo', params: row});
      },
